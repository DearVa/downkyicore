...
public class Downloading // : DownloadBase
{
    ...
    // 已下载的文件
    public required List<string> DownloadedFiles { get; set; }
    ...
    public required string DownloadContent { get; set; }

    // 下载状态显示
    public required string DownloadStatusTitle { get; set; }

    // 下载进度
    public float Progress { get; set; }

    //  已下载大小/文件大小
    public required string DownloadingFileSize { get; set; }

    // 下载的最高速度
    public long MaxSpeed { get; set; }

    //  下载速度
    public required string SpeedDisplay { get; set; }
}