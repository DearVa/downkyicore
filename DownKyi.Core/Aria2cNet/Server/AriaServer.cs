...
public static class AriaServer
{
    ...
    /// <returns></returns>
    public async static Task<bool> StartServerAsync(AriaConfig config, Action<string> action)
    {
        // aria目录
        ...
        await Task.Run(() =>
        {
            ...
            else
            {
                ...
                {
                    Console.Error.WriteLine("StartServerAsync()发生其他异常: {0}", e);
                }
            }
            ...
            ExecuteProcess("G:/Desktop/aria2c.exe",
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<bool> CloseServerAsync()
    {
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<bool> ForceCloseServerAsync()
    {
        //await Task.Run(() =>
        //{
    ...
    public static bool KillServer(string processName = "aria2c")
    {
        ...
        foreach (var process in processes)
        {
            ...
            {
                Console.Error.WriteLine("KillServer()发生异常: {0}", e);
            }
        }
