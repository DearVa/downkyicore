...
public static class AriaClient
{
    ...
    private readonly static string JSONRPC = "2.0";
    ...
    /// <returns></returns>
    public async static Task<AriaAddUri> AddUriAsync(IEnumerable<string> uris, AriaSendOption option, int position = -1)
    {
    ...
    ///     the uploaded data is saved as a file named as the hex string of SHA-1 hash of data plus ".torrent" in the directory
    ...
    /// <param name="position"></param>
    /// <returns></returns>
    public async static Task<AriaAddTorrent> AddTorrentAsync(string torrent, List<string> uris, AriaSendOption option, int position = -1)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="position"></param>
    /// <returns></returns>
    public async static Task<AriaAddMetalink> AddMetalinkAsync(string metalink, List<string> uris, AriaSendOption option, int position = -1)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <returns></returns>
    public async static Task<AriaRemove> RemoveAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaRemove> ForceRemoveAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaPause> PauseAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaPause> PauseAllAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaPause> ForcePauseAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaPause> ForcePauseAllAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaPause> UnpauseAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaPause> UnpauseAllAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaTellStatus> TellStatus(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaGetUris> GetUrisAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaGetFiles> GetFilesAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaGetPeers> GetPeersAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaGetServers> GetServersAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaTellStatusList> TellActiveAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    ///     offset == -1 points last download in the waiting queue and offset == -2 points the download before the last
    ///     download, and so on.
    ...
    /// <returns></returns>
    public async static Task<AriaTellStatusList> TellWaitingAsync(int offset, int num)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="num"></param>
    /// <returns></returns>
    public async static Task<AriaTellStatusList> TellStoppedAsync(int offset, int num)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    ///     Additionally aria2.changePosition('2089b05ecca3d829', 0, 'POS_SET') will change its position to 0 (the beginning of
    ///     the queue).
    ...
    /// <returns></returns>
    public async static Task<AriaChangePosition> ChangePositionAsync(string gid, int pos, HowChangePosition how)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="position"></param>
    /// <returns></returns>
    public async static Task<AriaChangeUri> ChangeUriAsync(string gid, int fileIndex, List<string> delUris, List<string> addUris, int position = -1)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    ///     Note that this method does not return options which have no default value and have not been set on the
    ///     command-line,
    ///     in configuration files or RPC methods.
    /// </summary>
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaGetOption> GetOptionAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="option"></param>
    /// <returns></returns>
    public async static Task<AriaChangeOption> ChangeOptionAsync(string gid, object option)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaGetOption?> GetGlobalOptionAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="option"></param>
    /// <returns></returns>
    public async static Task<AriaChangeOption> ChangeGlobalOptionAsync(object option)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaGetGlobalStat> GetGlobalStatAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaRemove> PurgeDownloadResultAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <param name="gid"></param>
    /// <returns></returns>
    public async static Task<AriaRemove> RemoveDownloadResultAsync(string gid)
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaVersion> GetAriaVersionAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaGetSessionInfo> GetSessionInfoAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaShutdown> ShutdownAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaShutdown> ForceShutdownAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<AriaSaveSession> SaveSessionAsync()
    {
        var ariaParams = new List<object>
        {
            "token:" + token,
    ...
    /// <returns></returns>
    public async static Task<List<SystemMulticall>> MulticallAsync(List<SystemMulticallMathod> systemMulticallMathods)
    {
        var ariaParams = new List<object>
        {
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<SystemListMethods> ListMethodsAsync()
    {
        var ariaSend = new AriaSendData
        {
            Id = Guid.NewGuid().ToString("N"),
    ...
    /// </summary>
    /// <returns></returns>
    public async static Task<SystemListNotifications?> ListNotificationsAsync()
    {
        var ariaSend = new AriaSendData
        {
            Id = Guid.NewGuid().ToString("N"),
    ...
    /// <returns></returns>
    private static Task<T> GetRpcResponseAsync<T>(AriaSendData ariaSend)
    {
        return Request<T>(GetRpcUri(), ariaSend);
    }
    ...
    /// <returns></returns>
    private async static Task<T> Request<T>(string url, AriaSendData ariaSend, int retry = 3)
    {
        // 重试次数
        if (retry <= 0) throw new Exception("请求失败");

        try
        {
            var queries = HttpUtility.ParseQueryString(url);
            queries.Add("method", ariaSend.Method);
            queries.Add("id", ariaSend.Id);
            queries.Add("params", Convert.ToBase64String(Encoding.UTF8.GetBytes(JsonSerializer.Serialize(ariaSend.Params))));
            var request = new HttpRequestMessage
            {
                RequestUri = new UriBuilder(new Uri(url.Split('?')[0]))
                {
            ...
            return await JsonSerializer.DeserializeAsync<T>(stream) ?? throw new Exception("反序列化失败");
        }
        catch (IOException e)
        {
            Console.Error.WriteLine("Request()发生IO异常: {0}", e);
            return await Request<T>(url, ariaSend, retry - 1);
        }
        catch (Exception e)
        {
            Console.Error.WriteLine("Request()发生其他异常: {0}", e);
            return await Request<T>(url, ariaSend, retry - 1);
        }
    }
}