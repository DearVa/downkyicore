...
{
    private readonly static List<Quality> Resolutions =
    [
    ...
    private readonly static List<Quality> CodecIds = new()
    {
        new Quality
            { Name = "H.264/AVC", Id = 7 },
        new Quality
            { Name = "H.265/HEVC", Id = 12 },
        new Quality
            { Name = "AV1", Id = 13 },
    };

    private readonly static List<Quality> Qualities = new()
    {
        ...
        new Quality
            { Name = "高质量", Id = 30280 },
        new Quality
            { Name = "Dolby Atmos", Id = 30250 },
        new Quality
            { Name = "Hi-Res无损", Id = 30251 },
    };
