...
///     https://www.bilibili.com/medialist/play/ml1329019876/, https://www.bilibili.com/list/ml1329019876
///     <para />
///     用户空间：uid928123, UID928123, uid:928123, UID:928123, https://space.bilibili.com/928123
/// </summary>
public static class ParseEntrance
{
    public readonly static string WwwUrl = "https://www.bilibili.com";
    public readonly static string ShareWwwUrl = "https://www.bilibili.com/s";
    public readonly static string ShortUrl = "https://b23.tv/";
    public readonly static string MobileUrl = "https://m.bilibili.com";

    public readonly static string SpaceUrl = "https://space.bilibili.com";

    public readonly static string VideoUrl = $"{WwwUrl}/video/";
    public readonly static string BangumiUrl = $"{WwwUrl}/bangumi/play/";
    public readonly static string BangumiMediaUrl = $"{WwwUrl}/bangumi/media/";
    public readonly static string CheeseUrl = $"{WwwUrl}/cheese/play/";
    public readonly static string FavoritesUrl1 = $"{WwwUrl}/medialist/detail/";
    public readonly static string FavoritesUrl2 = $"{WwwUrl}/medialist/play/";
    public readonly static string FavoritesUrl3 = $"{WwwUrl}/list/";
